...
const dirCodes = path.join(__dirname, 'codes/python');
...
const dirInputs = path.join(__dirname, 'codes/python_inputs');
...
const executePYTHON = (language,code,input) => {
